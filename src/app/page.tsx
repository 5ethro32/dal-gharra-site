  ...
  return (
    <>
      ...
      <section className="hero">
        <p className="hero-tag">Risk &middot; Compliance &middot; Strategy</p>
        <h1>Dall <span className="amp">Gharra</span></h1>
        <p className="hero-subtitle">
          Two decades in finance. Culture, governance, and the people behind the numbers.
        </p>
      ...
      <div className="divider-band">
        <p className="quote">
          Good governance is invisible. You only notice it when it&apos;s absent.
        </p>
      </div>
      ...
      <div className="section">
        ...
        <ScrollReveal>
          <h2 className="section-title">
            Twenty years. Eight roles. Every layer of the institution.
          </h2>
        </ScrollReveal>
        <ScrollReveal>
          <p>
      ...
      <div className="divider-band">
        <p className="quote">
          Interested in governance, culture, or the future of banking?
        </p>
      </div>
      ...
      <div className="section" style={{ textAlign: 'center' }}>
        ...
        <ScrollReveal>
          <div className="connect-links">
            <a href="mailto:dgharra@hotmail.co.uk" className="connect-btn">
            ...
            <a href="https://www.linkedin.com/in/dall-gharra" target="_blank" rel="noopener noreferrer" className="connect-btn">
